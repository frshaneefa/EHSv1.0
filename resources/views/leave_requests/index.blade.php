                                        ...
                                        <div class="overflow-x-auto">
                                            <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                                                ...
                                                <div style="display: flex; gap: 0.3rem;">
                                                    <form action="{{ route('leave-requests.index') }}" method="GET" style="display: flex; gap: 0.3rem;">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @if(Auth::user()->is_admin || $leaveRequest->user_id === auth()->id())
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div style="display: flex; gap: 0.5rem;">
                                                                    <a href="{{ route('leave-requests.show', $leaveRequest->id) }}" class="btn btn-info btn-sm">
                                                                        View
                                                                    </a>
